...
import { Book, CheckCircle, Clock, Search, User } from "lucide-react";
...
export default function HifzSabaqPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Daily Hifz Sabaq</h1>
          <p className="text-sm text-zinc-400">Track and evaluate new memorization (Sabaq) for your halqa.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <GlassCard className="p-4 flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm text-zinc-400">Sabaq Heard</p>
            ...
            <GlassCard className="p-6 h-full flex flex-col">
              <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
                ...
                <div className="text-right">
                  <p className="text-xs text-zinc-500 mb-1">Last Sabaq</p>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-zinc-300 mb-2">Surah Name</label>
                  <Input 
                ...
                <div>
                  <label className="block text-sm font-medium text-zinc-300 mb-2">Starting Ayah</label>
                  <Input 
                    type="number" 
                    placeholder="e.g. 1" 
                ...
                <div>
                  <label className="block text-sm font-medium text-zinc-300 mb-2">Ending Ayah</label>
                  <Input 
                    type="number" 
                    placeholder="e.g. 15" 
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div>
                  <label className="block text-sm font-medium text-zinc-300 mb-2">Mutashabihat / Mistakes</label>
                  <Input 
                    type="number" 
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="F">F (Fail / Repeat)</option>
                  </select>
                </div>
              </div>
