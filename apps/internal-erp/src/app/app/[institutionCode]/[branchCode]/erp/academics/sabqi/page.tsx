  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-black font-semibold">Daily Sabqi (Recent Revision)</h1>
          <p className="text-sm text-slate-700 font-medium">Track and evaluate recent revisions (usually the last 1-2 Juz).</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <GlassCard className="p-4 flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm text-slate-700 font-medium">Sabqi Heard</p>
            <p className="text-2xl font-bold text-black font-semibold">5</p>
          </div>
        </GlassCard>
        <GlassCard className="p-4 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-black font-semibold">10</p>
          </div>
        </GlassCard>
      </div>
            ...
            <GlassCard className="p-6 h-full flex flex-col">
              <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-6">
                ...
                <div className="text-right">
                  <p className="text-xs text-slate-700 font-medium mb-1">Current Target Juz</p>
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  <label className="block text-sm font-medium text-slate-800 font-medium mb-2">Starting Juz / Ruba'</label>
                  <Input 
                    type="text" 
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-800 font-medium mb-2">Ending Juz / Ruba'</label>
                  <Input 
                    type="text" 
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-800 font-medium mb-2">Total Pages Revised</label>
                  <Input 
                    type="number" 
