    ...
    <div className="min-h-screen bg-transparent text-black font-semibold p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between p-6 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl backdrop-blur-xl">
        <div>
          ...
          <p className="text-sm text-slate-700 font-medium mt-1">Phase 4: Comprehensive Staff Management</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="text-[10px] text-slate-700 font-medium uppercase font-mono tracking-wider">Active Staff</span>
        ...
        <div className="p-4 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="text-[10px] text-slate-700 font-medium uppercase font-mono tracking-wider">Today's Attendance</span>
        ...
        <div className="p-4 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="text-[10px] text-slate-700 font-medium uppercase font-mono tracking-wider">Pending Leaves</span>
        ...
        <div className="p-4 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.05)] rounded-2xl backdrop-blur-md">
          <div className="flex justify-between items-start">
            <div>
              <span className="text-[10px] text-slate-700 font-medium uppercase font-mono tracking-wider">Next Payroll Run</span>
      ...
      {/* Navigation Grid */}
      <h2 className="text-lg font-semibold text-black font-medium mt-8 mb-4">HR Modules</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-xs text-slate-700 font-medium mt-2">Track daily check-ins, resolve absences, and approve leave requests.</p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-slate-700 font-medium mt-2">Generate monthly payroll batches, apply deductions, and issue payslips.</p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-slate-700 font-medium mt-2">Conduct periodic reviews, track Ustad KPIs, and record feedback.</p>
        </div>
      </div>
    </div>
  );
