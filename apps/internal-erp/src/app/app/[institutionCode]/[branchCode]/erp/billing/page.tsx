...
export default function Page() {
  ...
  return (
    <div className="p-8 w-full">
      <h1 className="text-2xl font-bold text-slate-800 mb-6">Financial Billing & Analytics Dashboard</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <Card className="bg-[#111827] border border-[#1F2937]">
          <CardBody>
            <p className="text-sm text-slate-500">Total Dues Pending</p>
        ...
        <Card className="bg-[#111827] border border-[#1F2937]">
          <CardBody>
            <p className="text-sm text-slate-500">Collected Fees (MTD)</p>
        ...
        <Card className="bg-[#111827] border border-[#1F2937]">
          <CardBody>
            <p className="text-sm text-slate-500">Ledger Assets (Cash/Bank)</p>
        ...
        <Card className="bg-[#111827] border border-[#1F2937]">
          <CardBody>
            <p className="text-sm text-slate-500">Unreconciled Receipts</p>
      ...
      <div className="flex space-x-4">
        ...
        <Link href={`/app/${institutionCode}/${branchCode}/erp/ledger`} className="px-4 py-2 border border-gray-600 text-slate-600 font-semibold rounded-md hover:bg-gray-800 transition-colors">
          View General Ledger
        </Link>
      </div>
