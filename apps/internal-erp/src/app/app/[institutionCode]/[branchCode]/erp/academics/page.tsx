                  ...
                  {/* TAB 4: COMMUNICATION AI DISPATCH */}
                    {activeTab === "COMMUNICATION" && (
                      <div className="flex items-center justify-end w-full">
                        <button 
                          onClick={() => alert(`Webhook Triggered: Sending WhatsApp progress report to ${student.parentPhone}`)}
                          className="px-5 py-2.5 bg-[#25D366] hover:bg-[#1DA851] text-white rounded-xl text-xs font-bold flex items-center space-x-2 transition-all shadow-[0_0_15px_rgba(37,211,102,0.15)]"
                        >
