...
FILE_PATH = r"E:\Huffathul Hifaaz_asl\apps\internal-erp\src\app\app\[institutionCode]\[branchCode]\erp\academics\manzil\page.tsx"
...
import { Layers, CheckCircle, Clock, Search, User } from "lucide-react";

// Mock Data for UI Demonstration
const MOCK_STUDENTS = [
  { id: "STU-001", name: "Ahmed Abdullah", status: "pending", memorizedJuz: 15 },
  { id: "STU-002", name: "Omar Farooq", status: "completed", memorizedJuz: 3 },
  { id: "STU-003", name: "Zaid Bin Harith", status: "pending", memorizedJuz: 30 },
  { id: "STU-004", name: "Ali Hassan", status: "absent", memorizedJuz: 12 },
  { id: "STU-005", name: "Bilal Rabah", status: "pending", memorizedJuz: 7 },
];

export default function ManzilPage() {
